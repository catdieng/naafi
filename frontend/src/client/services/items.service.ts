...
export const ItemsService = {
	 ...
	 * @throws ApiError
	 */
	readItem(data: ItemsReadItemData): CancelablePromise<ItemsReadItemResponse> {
		return __request(OpenAPI, {
			method: "GET",
			url: "/api/v1/items/{id}/",
			path: {
	 ...
	 * @throws ApiError
	 */
	readItemCategories(): CancelablePromise<ItemsReadItemsResponse> {
		return __request(OpenAPI, {
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	readItemsAll(): CancelablePromise<ItemsReadItemsResponse> {
		return __request(OpenAPI, {
			method: "GET",
